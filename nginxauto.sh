...
if [ $TAGINSTALL == 1 ]
then
	displayandexec "Init the default configuration file for NGinx" "$WGET https://raw.githubusercontent.com/Pc3ooT/nginx_pro/master/nginx.conf ; $WGET https://raw.githubusercontent.com/Pc3ooT/nginx_pro/master/default-site ; mv nginx.conf /etc/nginx/ ; mv default-site /etc/nginx/sites-enabled/"
fi
